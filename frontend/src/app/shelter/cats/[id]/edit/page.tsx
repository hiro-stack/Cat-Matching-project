...
import { Image as ImageIcon, Video as VideoIcon, Plus, X, Upload, Lock } from "lucide-react";
  ...
  const fetchCat = useCallback(async () => {
    ...
    try {
      ...
      setFormData({
        ...
        affection_level: catData.affection_level || 3,
        maintenance_level: catData.maintenance_level || "normal",
        activity_level: catData.activity_level || "unknown",
        personality: catData.personality || "",
        
        is_single_ok: catData.is_single_ok || false,
        is_elderly_ok: catData.is_elderly_ok || false,
        other_terms: catData.other_terms || "",
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                <div className="flex items-center justify-between mb-4 border-b pb-2">
                  ...
                  {!isSuperUser && (
                    <span className="flex items-center gap-1.5 px-3 py-1 bg-amber-50 text-amber-600 rounded-full text-xs font-bold border border-amber-100">
                      <Lock className="w-3.5 h-3.5" /> 管理者のみ編集可
                    </span>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* 名前 */}
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1.5 text-ellipsis">
                      名前 <span className="text-red-400 font-bold">*</span>
                    </label>
                    <input
                      type="text"
                      id="name"
                      ...
                      className={`w-full px-4 py-3 rounded-xl border ${errors.name ? 'border-red-500' : 'border-gray-200'} focus:border-blue-300 focus:ring-2 focus:ring-blue-100 outline-none transition-all ${!isSuperUser ? 'bg-gray-50 text-gray-500 cursor-not-allowed border-gray-100' : ''}`}
                    />
                  ...
                  <div>
                    <label htmlFor="gender" className="block text-sm font-medium text-gray-700 mb-1.5">
                      性別 <span className="text-red-400 font-bold">*</span>
                    </label>
                    <select
                      id="gender"
                      name="gender"
                      ...
                      onChange={handleChange}
                      disabled={!isSuperUser}
                      className={`w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-300 focus:ring-2 focus:ring-blue-100 outline-none transition-all ${!isSuperUser ? 'bg-gray-50 text-gray-500 cursor-not-allowed border-gray-100' : ''}`}
                    >
                  ...
                  <div>
                    <label htmlFor="estimated_age" className="block text-sm font-medium text-gray-700 mb-1.5">
                      推定年齢 (テキスト) <span className="text-red-400 font-bold">*</span>
                    </label>
                    <input
                      type="text"
                      id="estimated_age"
               ...
               <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        onChange={(e) => setFormData(prev => prev ? { ...prev, affection_level: parseInt(e.target.value) } : null)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            disabled={!isSuperUser}
                            className={`w-full px-4 py-3 rounded-xl border border-gray-200 outline-none transition-all ${!isSuperUser ? 'bg-gray-50 text-gray-500 cursor-not-allowed border-gray-100' : ''}`}
                        >
                ...
                {/* 紹介文 */}
                 <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      disabled={!isSuperUser}
                      className={`w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-300 focus:ring-2 focus:ring-blue-100 outline-none resize-none transition-all ${!isSuperUser ? 'bg-gray-50 text-gray-500 cursor-not-allowed border-gray-100' : ''}`}
                    />
                  </div>
              </div>
